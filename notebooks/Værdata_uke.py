...
start_dato = (idag - timedelta(days=7)).strftime("%Y-%m-%d")  # Startdato som string
slutt_dato = idag.strftime("%Y-%m-%d")  # Sluttdato som string
...
if response.status_code == 200:  # Sjekk om forespørselen var vellykket
    data = response.json()["data"]

    # Dictionaries for å lagre data
    temperatur_data = {}
    nedbør_data = {}
    vind_data = {}
    ...
    rows = []  # Liste for å samle data til CSV
    ...
    # Lag DataFrame og lagre til CSV
